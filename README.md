...
```toml
[dependencies]
credenshare = { git = "https://github.com/CredenShare/credenshare-sdk-rust", tag = "v0.1.0" }
```
...
```toml
credenshare = { git = "https://github.com/CredenShare/credenshare-sdk-rust", tag = "v0.1.0", default-features = false }
```
